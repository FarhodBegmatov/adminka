<footer id="footer" class="hoc clear">
    <div class="one_third first">
        <h1 class="logoname"><span>All</span>Day</h1>
    ...
    <div class="one_third">
        ...
        <form method="post" action="#">
            <fieldset>
                ...
                <label for="newsletter_name"></label>
                <input class="btmspace-15" type="text" id="newsletter_name" name="newsletter_name" value="" placeholder="Name">
                <label for="newsletter_email"></label>
                <input class="btmspace-15" type="text" id="newsletter_email" name="newsletter_email" value="" placeholder="Email">
